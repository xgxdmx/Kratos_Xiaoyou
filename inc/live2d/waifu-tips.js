...
live2d_settings['homePageUrl']          = 'https://www.xgxdmx.com/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.xgxdmx.com/about_me/';   // 关于页地址, '{URL 网址}'
...
function initModel(waifuPath, type) {
   ...
   // console.clear();
    console.log("%c ","background:url(https://img.xgxdmx.com/images/2019/02/24/clannad-wallpapers-25790-2571881.jpg) no-repeat center;background-size:cover;padding-left:100%;padding-bottom:55%;overflow:hidden;border-radius:10px;margin:5px 0");
    console.log("\n %c Kratos modified %c by \u661F\u5149\u4E0B\u7684\u68A6\u60F3 xgxdmx.com \n","color:#444;background:#eee;padding:5px 0;","color:#fff;background:#876;padding:5px 0;");
    ...
    if (!live2d_settings.canEyesCare)        $('.waifu-tool .wifu-moon').hide();
